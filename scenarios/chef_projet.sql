...
INSERT INTO admin10.projets (id_projet, nom_projet, id_chef_de_projet, id_pole) VALUES (505, 'Projet E', '109', 3);
SELECT * FROM admin10.PROJETS;

SELECT * FROM admin10.TACHES;
UPDATE admin10.taches SET nom_tache = "taches_correction";
INSERT INTO admin10.taches (id_tache, nom_tache, id_responsable_tache, etat_tache, id_projet) VALUES (1005, 'Tâche 5', 104, 'En cours', 505);
SELECT * FROM admin10.TACHES;
